...
@section('page_header')
	...
	<div class="page-title">
		...
		<h1>
			<span class="text-semibold"><i class="icon-list2"></i> {{ trans('messages.twilio_numbers') }}</span>
		</h1>
	</div>
...
@section('content')
	<div class="row">
		@component('admin.common-components.breadcrumb')
			@slot('title') {{ trans('messages.twilio_numbers') }} @endslot
			@slot('li1') {{ \Acelle\Model\Setting::get("site_name") }}  @endslot
			@slot('li2') Admin  @endslot
			@slot('li3') {{ trans('messages.twilio_numbers') }} @endslot
		@endcomponent
	</div>
	<div class="card">
		<div class="card-body">
			<form class="listing-form"
				...
				data-url="{{ action('Admin\TwilioIntegrationController@listing') }}"
			...
			>
				<div class="row top-list-controls">
					...
					@can('create', new Acelle\Model\TwilioNumber())
						<div class="col-md-2 text-right">
							<a href="{{ action("Admin\AdminController@create") }}" type="button" class="btn btn-info">
