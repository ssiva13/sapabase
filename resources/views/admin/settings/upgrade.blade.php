...
@section('content')
    <div class="row">
        @component('admin.common-components.settings_breadcrumb')
            ...
            @slot('li4') {{ trans('messages.upgrade.title.upgrade') }} @endslot
        @endcomponent
    </div>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-muted text-center"><strong>{{ trans('messages.upgrade_manager') }}</strong></h4>
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12">
                            ...
                            @else
                                ...
                                <form action="{{ action('Admin\SettingController@uploadApplicationPatch') }}" class="form-validate-jquery" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <button class="btn btn-primary">{{ trans('messages.upload') }}</button>
                                </form>
                            @endif
                        </div>
                            </div>
