...
@section('content')
    <div class="row">
        @component('admin.common-components.breadcrumb')
            @slot('title') {{ trans('messages.admin_groups') }}  @endslot
            @slot('li1') {{ \Acelle\Model\Setting::get("site_name") }}  @endslot
            @slot('li2') Admin  @endslot
            @slot('li3') {{ trans('messages.admin_groups') }} @endslot
        @endcomponent
    </div>
    <div class="card">
        <div class="card-body">
                ...
                <div class="row top-list-controls">
                    ...
                    @can('create', new Acelle\Model\AdminGroup())
                        <div class="col-md-2 text-right">
                            <a href="{{ action("Admin\AdminGroupController@create") }}" type="button" class="btn btn-info">
