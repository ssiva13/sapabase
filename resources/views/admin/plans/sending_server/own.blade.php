        ...
        <div class="card-body">
            <form action="{{ action('Admin\PlanController@sendingServerOwn', $plan->uid) }}" method="POST" class="form-validate-jqueryx">
                ...
                <div class="mc-section">
                    <div class="announce_box">
                        <div class="row flex-center">
                            ...
                            <div class="col-md-4 text-right">
                                <a class="btn btn-primary mr-20 mc-modal-control" modal-size="lg" href="{{ action('Admin\PlanController@sendingServerOption', [
                                    'id' => $plan->uid]) }}">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-muted text-center"><strong>{{ trans('messages.plan.sending_servers.own.setting') }}</strong></h4>
