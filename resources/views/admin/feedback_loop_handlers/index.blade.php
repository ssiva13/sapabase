				...
				<div class="row top-list-controls">
					<div class="col-md-9">
						@if ($items->count() >= 0)
							<div class="filter-box">
										...
										<div class="media-body">
											<ol class="activity-feed mb-0">
												<li class="dropdown-item">
													<a delete-confirm="{{ trans('messages.delete_feedback_loop_handlers_confirm') }}" href="{{ action('Admin\FeedbackLoopHandlerController@delete') }}">
								...
								<div class="checkbox inline check_all_list m-1">
									<label>
					...
					@can('create', new Acelle\Model\FeedbackLoopHandler())
						<div class="col-md-3 text-right">
							<a href="{{ action('Admin\FeedbackLoopHandlerController@create') }}" type="button" class="btn btn-info">
