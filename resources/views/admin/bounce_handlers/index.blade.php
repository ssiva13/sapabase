...
@section('content')
	<div class="row">
		@component('admin.common-components.breadcrumb')
			@slot('title') {{ trans('messages.bounce_handlers') }}  @endslot
			@slot('li1') {{ \Acelle\Model\Setting::get("site_name") }}  @endslot
			@slot('li2') Admin  @endslot
			@slot('li3') {{ trans('messages.bounce_handlers') }} @endslot
		@endcomponent
	</div>
	<div class="card">
		<div class="card-body">
										...
										<div class="media-body">
											<ol class="activity-feed mb-0">
												<li class="dropdown-item">
													<a delete-confirm="{{ trans('messages.delete_bounce_handlers_confirm') }}" href="{{ action('Admin\BounceHandlerController@delete') }}">
