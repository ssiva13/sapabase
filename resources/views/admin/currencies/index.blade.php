...
@section('content')
	<div class="row">
		@component('admin.common-components.breadcrumb')
			@slot('title') {{ trans('messages.currencies') }}  @endslot
			@slot('li1') {{ \Acelle\Model\Setting::get("site_name") }}  @endslot
			@slot('li2') Admin  @endslot
			@slot('li3') {{ trans('messages.currencies') }} @endslot
		@endcomponent
	</div>
	<div class="card">
		<div class="card-body">
			<form class="listing-form" sort-url="{{ action('Admin\CurrencyController@sort') }}"
				  data-url="{{ action('Admin\CurrencyController@listing') }}" per-page="{{ Acelle\Model\Admin::$itemsPerPage }}" >
				<div class="row top-list-controls">
									...
									<div data-simplebar style="max-height: 230px;" class="dropdown-menu dropdown-menu-right" >
										<div class="media-body">
											<ol class="activity-feed mb-0">
												<li>
													<a delete-confirm="{{ trans('messages.enable_currencies_confirm') }}" class="copy-plan-link" href="{{ action('Admin\CurrencyController@enable') }}">
												...
												<li>
													<a link-confirm="{{ trans('messages.disable_currencies_confirm') }}" class="copy-plan-link" href="{{ action('Admin\CurrencyController@disable') }}">
														<div class="text-muted">
															<p class="mb-1">
												...
												<li>
													<a delete-confirm="{{ trans('messages.delete_currencies_confirm') }}" class="copy-plan-link" href="{{ action('Admin\CurrencyController@delete') }}">
														<div class="text-muted">
															<p class="mb-1">
					...
					@can('create', new Acelle\Model\Currency())
						<div class="col-md-2 text-right">
							<a href="{{ action("Admin\CurrencyController@create") }}" type="button" class="btn btn-info">
