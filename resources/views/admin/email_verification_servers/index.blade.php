				...
				<div class="row top-list-controls">
										...
										<div class="media-body">
											<ol class="activity-feed mb-0">
												<li class="dropdown-item">
													<a link-confirm="{{ trans('messages.enable_email_verification_servers_confirm') }}" href="{{ action('Admin\EmailVerificationServerController@enable') }}">
												...
												<li class="dropdown-item">
													<a link-confirm="{{ trans('messages.disable_email_verification_servers_confirm') }}" href="{{ action('Admin\EmailVerificationServerController@disable') }}">
														<div class="text-muted">
															<p class="mb-1">
												...
												<li class="dropdown-item">
													<a delete-confirm="{{ trans('messages.delete_email_verification_servers_confirm') }}" href="{{ action('Admin\EmailVerificationServerController@delete') }}">
														<div class="text-muted">
															<p class="mb-1">
					...
					@if (Auth::user()->admin->can('create', new Acelle\Model\EmailVerificationServer()))
						<div class="col-md-2 text-right">
							<a href="{{ action("Admin\EmailVerificationServerController@create") }}" type="button" class="btn btn-info">
