...
<head>
    ...
    <meta charset="utf-8" />
    <title> @yield('title') App | Responsive Bootstrap 4 Admin Dashboard</title>
...
<body data-sidebar="dark" class="navbar-top  color-scheme-{{ Auth::user()->admin->getColorScheme() }}">
...
{{--            <script src="{{ URL::asset('/libs/jquery/jquery.min.js')}}"></script>--}}
            ...
            <!-- App js -->
            <script src="{{ URL::asset('/js/admin/admin_app.min.js')}}"></script>
</body>
