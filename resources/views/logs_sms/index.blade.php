...
@section('page_header')
    ...
    <div class="page-title">
        ...
        <h1>
            <span class="text-semibold"><i class="icon-envelop5"></i> {{ trans('messages.sms.logs') }}</span>
        </h1>
    </div>
...
@section('content')
    <form class="listing-form"
          sort-url="{{ action('SmsLogsController@sort') }}"
          data-url="{{ action('SmsLogsController@listing') }}"
    ...
    >
        <div class="row top-list-controls">
            ...
            <div class="col-md-2 text-right">
                <a href="{{ action("SmsLogsController@refresh") }}" type="button" class="btn bg-info-800">
