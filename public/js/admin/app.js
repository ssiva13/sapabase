...
$(function ($) {
    ...
    function updateThemeSetting(id) {
        if($("#light-mode-switch").prop("checked") == true && id === "light-mode-switch"){
            ...
            $("#bootstrap-style").attr('href','css/admin/bootstrap.min.css');
            $("#app-style").attr('href','css/admin/app.min.css');
            sessionStorage.setItem("is_visited", "light-mode-switch");
        } else if($("#dark-mode-switch").prop("checked") == true && id === "dark-mode-switch"){
            $("#light-mode-switch").prop("checked", false);
            $("#rtl-mode-switch").prop("checked", false);
            $("#bootstrap-style").attr('href','css/admin/bootstrap-dark.min.css');
            $("#app-style").attr('href','css/admin/app-dark.min.css');
            sessionStorage.setItem("is_visited", "dark-mode-switch");
        } else if($("#rtl-mode-switch").prop("checked") == true && id === "rtl-mode-switch"){
            $("#light-mode-switch").prop("checked", false);
            $("#dark-mode-switch").prop("checked", false);
            $("#bootstrap-style").attr('href','css/admin/bootstrap.min.css');
            $("#app-style").attr('href','css/admin/app-rtl.min.css');
